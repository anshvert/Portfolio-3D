...
export function LamboCountach(props) {
  const { nodes, materials } = useGLTF('/lamboCountach/scene.gltf')
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <mesh geometry={nodes.Object_10.geometry} material={materials['Material.042']} />
        ...
        <mesh geometry={nodes.Object_26.geometry} material={materials['Material.017']} />
        ...
        <mesh geometry={nodes.Object_33.geometry} material={materials['Material.025']} />
...
useGLTF.preload('/lamboCountach/scene.gltf')
